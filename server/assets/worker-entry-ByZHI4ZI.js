...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-XLVTs2fP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CHogCiKX.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "battysvilla";
var SERVER_FN_BASE = "/battysvilla/_serverFn/";
